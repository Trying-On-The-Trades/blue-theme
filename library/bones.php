...
function bones_scripts_and_styles()
{
    ...
    if (!is_admin()) {
        ...
        wp_register_script('bootstrap', get_stylesheet_directory_uri() . '/library/js/bootstrap.min.js', array(), '2.5.3', true);
        ...
        wp_register_style('bootstrap-min', get_stylesheet_directory_uri() . '/library/css/bootstrap.min.css', array(), '');
